...
public class EALauncher : ILauncher
{
    [ImportingConstructor]
    public EALauncher(LauncherOptions? launcherOptions)
    {
    ...
    public void Refresh(CancellationToken cancellationToken = default)
    {
        ...
        if (!string.IsNullOrEmpty(Executable))
        {
            ...
            Games = EAGameFactory.GetGames(this, cancellationToken);
        }
    }
    #endregion
    ...
    private static string? GetExecutable()
    {
        ...
        executablePath ??= RegistryUtil.GetValue(RegistryHive.LocalMachine, @"SOFTWARE\Electronic Arts\EA Desktop", "ClientPath");
        executablePath ??= RegistryUtil.GetValue(RegistryHive.LocalMachine, @"SOFTWARE\Electronic Arts\EA Desktop", "DesktopAppPath");
